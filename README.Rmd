...
Dependent variable must be normal within each group as proven by `test_normality()` function, and $\ge 30$ to pass for parametric tests. Variances tested by `leveneTest()` must be homogeneous to pass for T-Test, else Welch-Test is used.
