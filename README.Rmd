...
![Report of `test_ttest()` (`ToothGrowth$len`, `ToothGrowth$supp`)](img/test_ttest_report.png)

![Plot of `test_ttest()` (`ToothGrowth$len`, `ToothGrowth$supp`)](img/test_ttest_plot.png)
